...
class PersonInLine(models.Model):
    ...
    child_middle_name = models.CharField(max_length=30, verbose_name="По-батькові", blank=True)
    child_birthday = models.DateField(verbose_name='день народження', blank=True)
    birth_certificate = models.CharField(max_length=15,
                                         verbose_name='Свідоцтво про народження',
                                         blank=True)
    certificate_issued = models.CharField(max_length=125, verbose_name='Ким видане', blank=True)
    address = models.CharField(max_length=200, verbose_name='адреса', blank=True)
    wish_year = models.IntegerField(choices=YEAR_CHOICES, default=0, verbose_name='Рік зарахування')
    parent_last_name = models.CharField(max_length=50, verbose_name="Прізвище батька", blank=True)
    parent_first_name = models.CharField(max_length=30, verbose_name="Ім'я батька", blank=True)
    parent_middle_name = models.CharField(max_length=30, verbose_name="По-батькові", blank=True)
